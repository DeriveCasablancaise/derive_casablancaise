...
export interface IDerive2022 extends Document {
  _id: string;
  text1Fr: string;
  text1Ar?: string;
...
const Derive2022Schema = new Schema(
  {
    text1Fr: {
      type: String,
      required: true,
...
const Derive2022 = models?.Derive2022 || model('Derive2022', Derive2022Schema);

export default Derive2022;
