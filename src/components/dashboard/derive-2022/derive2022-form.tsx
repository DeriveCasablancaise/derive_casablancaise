...
type Derive2022FormProps = {
  derive2022?: IDerive2022;
};

const Derive2022Form = ({ derive2022 }: Derive2022FormProps) => {
  ...
  const initialValues = derive2022 || {
    text1Fr: '',
    text1Ar: '',
    text2Fr: '',
    text2Ar: '',
  ...
  useEffect(() => {
    if (derive2022) {
      form.reset({
        text1Fr: derive2022.text1Fr || '',
        text1Ar: derive2022.text1Ar || '',
        text2Fr: derive2022.text2Fr || '',
        text2Ar: derive2022.text2Ar || '',
        text3Fr: derive2022.text3Fr || '',
        text3Ar: derive2022.text3Ar || '',
        backgroundImage: derive2022.backgroundImage || '',
        video1Thumbnail: derive2022.video1Thumbnail || '',
        video1IframeLink: derive2022.video1IframeLink || '',
        video1TitleFr: derive2022.video1TitleFr || '',
        video1TitleAr: derive2022.video1TitleAr || '',
        video2Thumbnail: derive2022.video2Thumbnail || '',
        video2IframeLink: derive2022.video2IframeLink || '',
        video2TitleFr: derive2022.video2TitleFr || '',
        video2TitleAr: derive2022.video2TitleAr || '',
      });
      setVideo1File(null);
      setVideo2File(null);
      setBgImageFile(null);
  ...
  async function onSubmit(values: z.infer<typeof derive2024FormSchema>) {
    ...
    try {
      const result = await updateDerive2022({
        derive2022: {
          ...updatedValues,
          _id: derive2022?._id,
        },
      ...
      if (result) {
        router.push('/darja-admin/derive-2022');
      }
    } catch (error) {
      console.error('Error updating derive2022:', error);
      handleError(error);
    }
