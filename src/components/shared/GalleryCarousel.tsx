...
const GalleryCarousel: React.FC<ImageGalleryProps> = ({ images, alt }) => {
  ...
  if (images.length === 1) {
    return (
      <div className="w-full">
        <div className="relative aspect-video overflow-hidden max-h-[80vh]">
          <Image
            src={images[0]}
            alt={alt}
            layout="fill"
  ...
  return (
    <div className="w-full space-y-4 flex flex-col  ">
      {/* Main Image Display */}
      <div className="relative aspect-video overflow-hidden group max-h-[75vh]">
        <Image
